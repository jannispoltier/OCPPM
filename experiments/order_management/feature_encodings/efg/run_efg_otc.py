...
train_loader, val_loader, test_loader = data_utils.prepare_dataloaders(
    ...
    seed_worker=functools.partial(
        utilities.torch_utils.seed_worker, state=otc_efg_config["RANDOM_SEED"]
    ),
...
print()
print("Running hyperparameter tuning process for EFG on Order Management OCEL")

otc_efg_config["verbose"] = False
otc_efg_config["model_output_path"] = "models/OTC/efg/exp_v2/no_subgraph_sampling"
# CHECK BATCH SIZE
